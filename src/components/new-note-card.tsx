            ...
            >
              ...
              <div className='flex flex-1 flex-col gap-3 p-5'>
                ...
                {shouldShowOnboarding ? (
                  <p className='text-sm leading-4 text-slate-300'>
                    <span>Comece </span> 
                    <button 
                      type='button'
                    ...
                    <span> em áudio ou se preferir </span> 
                    <button 
                      type='button'
                      className='font-medium text-lime-400 hover:underline' onClick={handleStartEditor}
                    >
